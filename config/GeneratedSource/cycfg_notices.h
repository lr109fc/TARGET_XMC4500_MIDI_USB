...
#error "Unexpected MPN; expected DEVICE:=XMC4500-F100x1024. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(XMC4500_F100x1024) */
